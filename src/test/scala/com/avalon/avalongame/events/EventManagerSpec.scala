...
//  }
  ...
  test("Massive test, need some refactoring to make these way more specific") {
    forAll { (roomId: RoomId, gameConfig: GameConfig) =>
      new context {
...
//        AllReady(missionNumebr: Int, missionLeader: Nickname, missions: Missions) extends PlayerReadyEnum
